...
public class ImageUtil {
	  ...
	  String output = "F:/images/";
	    String source = "F:/images/source.jpg";  //源图片路径
	    ...
	    String result = null;
	    //给图片添加图片水印
//	    result = ImageUtil.markImageByMoreIcon(icon,source,output,imageName,imageType,degree);
//	    result = ImageUtil.markImageBySingleIcon(icon, source, output, imageName, imageType, degree);
//	    //给图片添加文字水印
//	    result = ImageUtil.markImageByMoreText(source,output,imageName,imageType,Color.red,text,degree);
	    result = ImageUtil.markImageBySingleText(source,output,imageName,imageType,Color.red,text,degree);
//	    //给图片打马赛克
