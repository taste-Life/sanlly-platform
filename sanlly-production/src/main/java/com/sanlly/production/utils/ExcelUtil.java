...
public class ExcelUtil {
	...
	public static void writeTemplate1(File file,List<List<String>> dataList) {
		...
		try {
			...
			for (int i = 0; i < dataList.size(); i++) {
				...
				// 得到要插入的每一条记录
				List<String> dataMap = dataList.get(i);
	...
	public static void main(String[] args) {
		System.out.println(String.format("%.2f", 12.0000d));
//		List<List<String>> dataList=new ArrayList<>();
//		dataList.add(Arrays.asList("BMOU9703979","DB3N","GTP","SN","BR","MU","20","0","1","U","1.17","5.85","4.67"));
//		dataList.add(Arrays.asList("BMOU9703979","RG3N","RLA","GS","DT","ST","80","0","1","U","1.33","6.65","12"));
//		writeTemplate1(new File("D:/writeExcel.xls"),dataList);
