...
public class SparePartsOutput {
    ...
    public List getTexture() {
        return texture;
    }

    public void setTexture(List texture) {
        this.texture = texture;
    }

    public List getApplicableModels() {
        return applicableModels;
    }

    public void setApplicableModels(List applicableModels) {
