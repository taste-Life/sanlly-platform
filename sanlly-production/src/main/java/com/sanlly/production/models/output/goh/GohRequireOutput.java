...
public class GohRequireOutput {
	...
	// 挂衣箱
	private List<SearecGohOutput> gohList;
	...
	public List<SearecGohOutput> getGohList() {
		return gohList;
	}

	public void setGohList(List<SearecGohOutput> gohList) {
		this.gohList = gohList;
	}
