package com.sanlly.production.models.output.unit;

public class UnitRepairEntryOutput {
    ...
    public String getUnitRepair() {
        return unitRepair;
    }

    public void setUnitRepair(String unitRepair) {
