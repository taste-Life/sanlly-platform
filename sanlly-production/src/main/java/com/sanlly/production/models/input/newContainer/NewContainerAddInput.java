package com.sanlly.production.models.input.newContainer;
 ...
 *
 */
public class NewContainerAddInput {
     ...
     * 订单明细
     */
    private List<ContainerOrderDetail> details;
	...
	public List<ContainerOrderDetail> getDetails() {
		return details;
	}

	public void setDetails(List<ContainerOrderDetail> details) {
