...
public class ContainerUser {
    ...
    public void setContainerUserCode(String containerUserCode) {
        this.containerUserCode = containerUserCode == null ? null : containerUserCode.trim();
    }
    ...
    public void setContainerUserName(String containerUserName) {
        this.containerUserName = containerUserName == null ? null : containerUserName.trim();
    }
    ...
    public void setContainerUserNameEn(String containerUserNameEn) {
        this.containerUserNameEn = containerUserNameEn == null ? null : containerUserNameEn.trim();
    }
