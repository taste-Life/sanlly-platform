...
public class SpareParts {
    ...
    public void setSparePartsCategoriesDetails(String sparePartsCategoriesDetails) {
        this.sparePartsCategoriesDetails = sparePartsCategoriesDetails == null ? null : sparePartsCategoriesDetails.trim();
    }
    ...
    public void setSparePartsNameEn(String sparePartsNameEn) {
        this.sparePartsNameEn = sparePartsNameEn == null ? null : sparePartsNameEn.trim();
    }
    ...
    public void setSparePartsGeneralId(String sparePartsGeneralId) {
        this.sparePartsGeneralId = sparePartsGeneralId == null ? null : sparePartsGeneralId.trim();
    }
    ...
    public void setSparePartsSpec(String sparePartsSpec) {
        this.sparePartsSpec = sparePartsSpec == null ? null : sparePartsSpec.trim();
    }
    ...
    public void setIsIncise(String isIncise) {
        this.isIncise = isIncise == null ? null : isIncise.trim();
    }
    ...
    public void setIsMergerAcquisition(String isMergerAcquisition) {
        this.isMergerAcquisition = isMergerAcquisition == null ? null : isMergerAcquisition.trim();
    }
    ...
    public void setComponentDetails(String componentDetails) {
        this.componentDetails = componentDetails == null ? null : componentDetails.trim();
    }
    ...
    public void setIsSendBack(String isSendBack) {
        this.isSendBack = isSendBack == null ? null : isSendBack.trim();
    }
    ...
    public void setInquiryCycle(String inquiryCycle) {
        this.inquiryCycle = inquiryCycle == null ? null : inquiryCycle.trim();
    }
