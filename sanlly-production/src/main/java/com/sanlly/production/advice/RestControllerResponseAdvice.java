package com.sanlly.production.advice;
		...
		if(selectedContentType.equals(MediaType.APPLICATION_JSON)) {
			...
			if (StringUtils.isNotEmpty(value)) {
				...
				if (arr[0].equals("en") || arr[0].toLowerCase().equals("en-us")) {
					return langService.lang(new LangInput(body, LanguageEnum.LANGEN, uri));
				} else if (arr[0].equals("zh") || arr[0].toLowerCase().equals("zh-cn")) {
					return langService.lang(new LangInput(body, LanguageEnum.LANGZH, uri));
				}
			}
		}
