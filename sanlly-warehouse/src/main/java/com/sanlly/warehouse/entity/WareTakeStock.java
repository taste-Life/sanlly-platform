...
public class WareTakeStock {
    private Integer wareTakeStockId;
    ...
    public Integer getWareTakeStockId() {
        return wareTakeStockId;
    }

    public void setWareTakeStockId(Integer wareTakeStockId) {
        this.wareTakeStockId = wareTakeStockId;
    }
