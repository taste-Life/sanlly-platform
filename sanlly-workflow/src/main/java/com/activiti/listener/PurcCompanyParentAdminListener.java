...
/**
 * 采购任务监听器 供应商注册用总公司管理员处理
 * 
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author mx
 * @date 2019年7月31日 流程图中添加任务监听器 -- 委托表达式 ${purcCompanyParentAdminListener} 为了是spring
 *       注解 @Autowired 在任务监听器中生效
 * 
 */
@Service("purcCompanyParentAdminListener")
public class PurcCompanyParentAdminListener implements JavaDelegate, TaskListener {
