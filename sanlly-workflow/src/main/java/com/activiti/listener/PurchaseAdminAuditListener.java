...
* @author jlx
* 
* 流程图中添加任务监听器  --  委托表达式 ${purchaseAdminAuditListener}  为了是spring 注解 @Autowired 在任务监听器中生效
* 监听器添加的角色id字段需要实现JavaDelegate，才能获取到角色id的值
 */
@Service("purchaseAdminAuditListener")
public class PurchaseAdminAuditListener implements JavaDelegate,TaskListener {
	...
	*/  
	...
	public void notify(DelegateTask delegateTask) {
		...
		List<UserInfoOutput> listUser = authService.getPurchaseAdminAuditCompanyUserList(input);
