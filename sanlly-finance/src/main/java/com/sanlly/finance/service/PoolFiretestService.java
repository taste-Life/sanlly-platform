 ...
 *
 */
public interface PoolFiretestService {
	
	/**
	 *  分页查询
	* @Description: TODO 
	* @param input
	* @return PagedList<PoolFiretestOutput>
	* @throws 
	 */
	PagedList<PoolFiretestOutput> getPage(SearchBaseInput input);
	 ...
	 * @return（展示方法参数和返回值）
	 */
	Boolean addOrUpadte(PoolFiretestInput input);
	/**
	 * 批量修改
	* @Description: TODO 
	* @param input
	...
	* @throws 
	 */
	Boolean Upadtes(List<PoolFiretestInput> input);
	/**
	 * 批量删除
	 * @Description:（方法功能描述） 
	 * @param ids
