 ...
 *
 */
public interface PoolLeaseService {
	
	/**
	 *  分页查询
	* @Description: TODO 
	* @param input
	* @return PagedList<PoolLeaseOutput>
	* @throws 
	 */
	PagedList<PoolLeaseOutput> getPage(SearchBaseInput input);
	 ...
	 * @return（展示方法参数和返回值）
	 */
	Boolean addOrUpadte(PoolLeaseInput input);
	/**
	 * 批量修改
	* @Description: TODO 
	* @param input
	...
	* @throws 
	 */
	Boolean Upadtes(List<PoolLeaseInput> input);
	/**
	 * 批量删除
	 * @Description:（方法功能描述） 
	 * @param ids
