...
* @version V1.0   
 */
public interface BillSceneService {

	/**
	 *  分页查询
	* @Description: TODO 
	* @param input
	* @return PagedList<BillSceneOutput>
	* @throws 
	 */
	PagedList<BillSceneOutput> getPage(SearchBaseInput input);
	/**
	 * 创建账单和明细
	* @Description: TODO 
	* @return Boolean
	* @throws 
	 */
	Boolean createBill(List<BillSceneMDInput> list);
	...
	* @throws 
	 */
	String reductionBill(List<BillSceneMDInput> list);
	 ...
	 * @return（展示方法参数和返回值）
	 */
	Boolean add(BillSceneInput input);
	...
	* @throws 
	 */
	Boolean Upadtes(List<BillSceneInput> input);
	 ...
	 * @return（展示方法参数和返回值）
	 */
//	Boolean billFullAdjustmentReturnSubmit(String [] ids);
