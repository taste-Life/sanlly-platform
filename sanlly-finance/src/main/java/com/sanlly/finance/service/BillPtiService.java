 ...
 *
 */
public interface BillPtiService {
	 ...
	 * @Description: TODO
	 * @param input
	 * @return PagedList<BillPtiOutput> @throws 
	 */
	PagedList<BillPtiOutput> getPage(SearchBaseInput input);
	 ...
	 */
	Boolean createBill(BillPtiInput input);
	 ...
	 */
	Boolean add(BillPtiInput input);
	 ...
	 * @return Boolean @throws 
	 */
	Boolean Upadtes(List<BillPtiInput> input);
	 ...
	 * @return PagedList<BillPtiOutput> @throws 
	 */
	List<BillPtiDetailOutput> listDetail(SearchBaseInput input);
	 ...
	 * @return PagedList<BillPtiOutput> @throws 
	 */
	List<PoolPtiOutput> listPoolDetail(SearchBaseInput input);
