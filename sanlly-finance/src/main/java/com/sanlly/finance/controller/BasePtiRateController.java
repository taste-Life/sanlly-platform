 ...
 */
@RestController
@RequestMapping(value = "/basePtiRate")
public class BasePtiRateController {
	
	@Autowired
	private BasePtiRateService service;
	...
	public Result addOrUpadte(@RequestBody BasePtiRateInput input) {
