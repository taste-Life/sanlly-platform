 ...
 */
@RestController
@RequestMapping(value = "/baseCPYard")
public class BaseCPYardController {
	
	@Autowired
	private BaseCPYardService service;
	...
	public Result addOrUpadte(@RequestBody BaseCPYardInput input) {
