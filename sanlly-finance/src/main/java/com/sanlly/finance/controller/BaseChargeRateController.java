 ...
 */
@RestController
@RequestMapping(value = "/baseChargeRate")
public class BaseChargeRateController {
	
	@Autowired
	private BaseChargeRateService service;
	...
	public Result addOrUpadte(@RequestBody BaseChargeRateInput input) {
