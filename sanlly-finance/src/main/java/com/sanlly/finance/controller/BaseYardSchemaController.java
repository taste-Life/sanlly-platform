 ...
 */
@RestController
@RequestMapping(value = "/baseYardSchema")
public class BaseYardSchemaController {
	
	@Autowired
	private BaseYardSchemaService service;
	...
	public Result addOrUpadte(@RequestBody BaseYardSchemaInput input) {
