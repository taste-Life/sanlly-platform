 ...
 */
@RestController
@RequestMapping(value = "/baseWorkHoursRate")
public class BaseWorkHoursRateController {
	
	@Autowired
	private BaseWorkHoursRateService service;
	...
	public Result addOrUpadte(@RequestBody BaseWorkHoursRateInput input) {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	@PostMapping("/getWorkGroupList")
	public Result getWorkGroupList(@RequestBody SearchBaseInput input) {
		return Result.Success(service.getWorkGroupList(input));
	}
