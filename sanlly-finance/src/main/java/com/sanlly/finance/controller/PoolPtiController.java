 ...
 */
@RestController
@RequestMapping(value = "/poolPti")
public class PoolPtiController {
	
	@Autowired
	private PoolPtiService service;
	...
	public Result addOrUpadte(@RequestBody PoolPtiInput input) {
	...
	@SuppressWarnings("rawtypes")
	@PostMapping("/updates")
	public Result updates(@RequestBody List<PoolPtiInput> input) {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	@PostMapping("/ptiOkNode")
	public Result ptiOkNode(@RequestBody PoolPtiInput input) {
		return Result.Success(service.ptiOkNode(input));
	}
