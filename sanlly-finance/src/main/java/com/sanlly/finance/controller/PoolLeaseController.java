 ...
 */
@RestController
@RequestMapping(value = "/poolLease")
public class PoolLeaseController {
	
	@Autowired
	private PoolLeaseService service;
	...
	public Result addOrUpadte(@RequestBody PoolLeaseInput input) {
	...
	@SuppressWarnings("rawtypes")
	@PostMapping("/updates")
	public Result updates(@RequestBody List<PoolLeaseInput> input) {
