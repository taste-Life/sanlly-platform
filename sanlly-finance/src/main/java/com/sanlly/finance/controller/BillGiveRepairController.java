 ...
 */
@RestController
@RequestMapping(value = "/billGiveRepair")
public class BillGiveRepairController {
	
	@Autowired
	private BillGiveRepairService service;
	...
	public Result createBill(@RequestBody List<BillGiveRepairInput> list) {
	...
	@SuppressWarnings("rawtypes")
	@PostMapping("/add")
	public Result add(@RequestBody BillGiveRepairInput input) {
	...
	@SuppressWarnings("rawtypes")
	@PostMapping("/updates")
	public Result updates(@RequestBody List<BillGiveRepairInput> input) {
