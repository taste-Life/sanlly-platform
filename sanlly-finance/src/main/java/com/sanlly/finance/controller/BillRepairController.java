 ...
 */
@RestController
@RequestMapping(value = "/billRepair")
public class BillRepairController {
	
	@Autowired
	private BillRepairService service;
	
	@Autowired
	private BillRepairDetailService serviceDetail;
	...
	public Result createBill(@RequestBody BillRepairInput input) {
	...
	@SuppressWarnings("rawtypes")
	@PostMapping("/add")
	public Result add(@RequestBody BillRepairInput input) {
	...
	@SuppressWarnings("rawtypes")
	@PostMapping("/updates")
	public Result updates(@RequestBody List<BillRepairInput> input) {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	@PostMapping("/refreshDiscount")
	public Result  refreshDiscount(@RequestParam Integer billId){
		return Result.Success(service.refreshDiscount(billId));
	}
