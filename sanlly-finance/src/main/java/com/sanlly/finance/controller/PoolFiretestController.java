 ...
 */
@RestController
@RequestMapping(value = "/poolFiretest")
public class PoolFiretestController {
	
	@Autowired
	private PoolFiretestService service;
	...
	public Result addOrUpadte(@RequestBody PoolFiretestInput input) {
	...
	@SuppressWarnings("rawtypes")
	@PostMapping("/updates")
	public Result updates(@RequestBody List<PoolFiretestInput> input) {
