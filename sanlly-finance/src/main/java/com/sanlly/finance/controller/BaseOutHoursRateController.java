 ...
 */
@RestController
@RequestMapping(value = "/baseOutHoursRate")
public class BaseOutHoursRateController {
	
	@Autowired
	private BaseOutHoursRateService service;
	...
	public Result addOrUpadte(@RequestBody BaseOutHoursRateInput input) {
