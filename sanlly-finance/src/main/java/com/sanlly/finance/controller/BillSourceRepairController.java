 ...
 */
@RestController
@RequestMapping(value = "/billSourceRepair")
public class BillSourceRepairController {
	
	@Autowired
	private BillSourceRepairService service;
	
	@Autowired
	private BillSourceRepairDetailService serviceDetail;
	...
	public Result createBill(@RequestBody BillSourceRepairInput input) {
	...
	@SuppressWarnings("rawtypes")
	@PostMapping("/add")
	public Result add(@RequestBody BillSourceRepairInput input) {
	...
	@SuppressWarnings("rawtypes")
	@PostMapping("/updates")
	public Result updates(@RequestBody List<BillSourceRepairInput> input) {
