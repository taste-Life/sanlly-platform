 ...
 */
@RestController
@RequestMapping(value = "/baseAuditDept")
public class BaseAuditDeptController {
	
	@Autowired
	private BaseAuditDeptService service;
	...
	public Result addOrUpadte(@RequestBody BaseAuditDeptInput input) {
