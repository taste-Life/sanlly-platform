 ...
 */
@RestController
@RequestMapping(value = "/commonRate")
public class BaseCommonRateController {
	
	@Autowired
	private BaseCommonRateService service;
	...
	public Result addOrUpadte(@RequestBody BaseCommonRateInput input) {
