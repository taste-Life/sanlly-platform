...
public class BaseCategoryController {
	...
	public Result getList(@RequestBody SearchBaseInput input) {
		return Result.Success(baseCategoryService.list(input));
	}
	...
	public Result getPage(@RequestBody SearchBaseInput input) {
		return Result.Success(baseCategoryService.getPage(input));
	}
	...
	public Result addOrUpadte(@RequestBody BaseCategoryInput input) {
		return Result.Success(baseCategoryService.addOrUpadte(input));
	}
	...
	public Result deletes(@RequestParam String [] Ids) {
		return Result.Success(baseCategoryService.deletes(Ids));
	}
