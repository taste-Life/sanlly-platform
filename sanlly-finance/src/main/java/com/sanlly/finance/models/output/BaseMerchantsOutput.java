...
* @version V1.0   
 */
public class BaseMerchantsOutput {
	//主键
    private Integer id;
    //国际化key
    ...
    //国际化key
    private String merchantsKeyNameLang;
	...
	public String getMerchantsKeyNameLang() {
		return merchantsKeyNameLang;
	}

	public void setMerchantsKeyNameLang(String merchantsKeyNameLang) {
		this.merchantsKeyNameLang = merchantsKeyNameLang;
	}
