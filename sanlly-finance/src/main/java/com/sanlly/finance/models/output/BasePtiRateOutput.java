...
* @version V1.0   
 */
public class BasePtiRateOutput {
	//主键
    private Integer id;
	//公司key
	...
	//启用应收公式 0 :无 1：用
    private String isFormulaYsNameLang;
	//启用应付公式 0 :无 1：用
    private String isFormulaYfNameLang;
	//箱型尺寸
  ...
  //应收计算方式
    private String computeFormulaYsNameLang;
	//应收币种
    private String currencyTypeYsNameLang;
    
	//应付计算方式
    private String computeFormulaYfNameLang;
	//应付币种
    private String currencyTypeYfNameLang;
    //币种应付
    private String payCurrencyTypeNameLang;	
	...
	public String getIsFormulaYsNameLang() {
		return isFormulaYsNameLang;
	}

	public void setIsFormulaYsNameLang(String isFormulaYsNameLang) {
		this.isFormulaYsNameLang = isFormulaYsNameLang;
	}

	public String getIsFormulaYfNameLang() {
		return isFormulaYfNameLang;
	}

	public void setIsFormulaYfNameLang(String isFormulaYfNameLang) {
		this.isFormulaYfNameLang = isFormulaYfNameLang;
	}
	...
	public String getComputeFormulaYsNameLang() {
		return computeFormulaYsNameLang;
	}

	public void setComputeFormulaYsNameLang(String computeFormulaYsNameLang) {
		this.computeFormulaYsNameLang = computeFormulaYsNameLang;
	}

	public String getCurrencyTypeYsNameLang() {
		return currencyTypeYsNameLang;
	}

	public void setCurrencyTypeYsNameLang(String currencyTypeYsNameLang) {
		this.currencyTypeYsNameLang = currencyTypeYsNameLang;
	}

	public String getComputeFormulaYfNameLang() {
		return computeFormulaYfNameLang;
	}

	public void setComputeFormulaYfNameLang(String computeFormulaYfNameLang) {
		this.computeFormulaYfNameLang = computeFormulaYfNameLang;
	}

	public String getCurrencyTypeYfNameLang() {
		return currencyTypeYfNameLang;
	}

	public void setCurrencyTypeYfNameLang(String currencyTypeYfNameLang) {
		this.currencyTypeYfNameLang = currencyTypeYfNameLang;
	}
	...
	public String getPayCurrencyTypeNameLang() {
		return payCurrencyTypeNameLang;
	}

	public void setPayCurrencyTypeNameLang(String payCurrencyTypeNameLang) {
		this.payCurrencyTypeNameLang = payCurrencyTypeNameLang;
	}
