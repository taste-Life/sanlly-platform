...
* @version V1.0   
 */
public class BaseBillTypeOutput {
	//主键
    private Integer id;
	//国际化key
	...
	//账单名称
    private String billNameNameLang;
	//账单英文名称
	...
	public String getBillNameNameLang() {
		return billNameNameLang;
	}

	public void setBillNameNameLang(String billNameNameLang) {
		this.billNameNameLang = billNameNameLang;
	}
