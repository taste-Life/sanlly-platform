...
public class AddPurchaseOrderInput {
    ...
    // 商品详情
    List<AddPurchaseOrderDetailInput> details;
	...
	public List<AddPurchaseOrderDetailInput> getDetails() {
		return details;
	}
	public void setDetails(List<AddPurchaseOrderDetailInput> details) {
