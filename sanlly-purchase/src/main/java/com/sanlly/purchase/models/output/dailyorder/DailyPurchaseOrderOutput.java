...
public class DailyPurchaseOrderOutput {
	...
	// 商品详情
	List<DailyPurchaseOrderDetailOutput> details;
	...
	public List<DailyPurchaseOrderDetailOutput> getDetails() {
		return details;
	}
	public void setDetails(List<DailyPurchaseOrderDetailOutput> details) {
