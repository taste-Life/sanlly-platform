 ...
 * @Author mqz
 */
public class DailyReInquiryOutput {
    //主键
    ...
    // 竞价备件
    private List<DailyDemandOutput> demandOutputList;
    // 应邀供应商
    ...
    public List<DailyDemandOutput> getDemandOutputList() {
        return demandOutputList;
    }

    public void setDemandOutputList(List<DailyDemandOutput> demandOutputList) {
