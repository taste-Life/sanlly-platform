...
import com.sanlly.purchase.models.output.dailybidding.DailyBiddingProductOutput;
import com.sanlly.purchase.models.output.dailybidding.DailyBiddingSupplierOutput;
...
/**
 * @Description: TODO
 * @ClassName: DailyInquiryOutput
 * @Version 1.0
 * @Author mqz
 */
public class DailyInquiryOutput {
    //主键
    ...
    // 竞价备件
    private List<DailyBiddingProductOutput> tenderProductOutputList;
    // 应邀供应商
    private List<DailyBiddingSupplierOutput> tenderInviteSupplierOutputList;
    // 初审供应商
    private List<DailyBiddingSupplierOutput> tenderFirstSupplierOutputList;
    // 签到供应商
    private List<DailyBiddingSupplierOutput> tenderSignSupplierOutputList;
    //报价供应商
    private List<DailyBiddingSupplierOutput> tenderQuoteSupplierOutputList;

    public List<DailyBiddingSupplierOutput> getTenderQuoteSupplierOutputList() {
        return tenderQuoteSupplierOutputList;
    }

    public void setTenderQuoteSupplierOutputList(List<DailyBiddingSupplierOutput> tenderQuoteSupplierOutputList) {
    ...
    public List<DailyBiddingProductOutput> getTenderProductOutputList() {
        return tenderProductOutputList;
    }

    public void setTenderProductOutputList(List<DailyBiddingProductOutput> tenderProductOutputList) {
        this.tenderProductOutputList = tenderProductOutputList;
    }

    public List<DailyBiddingSupplierOutput> getTenderInviteSupplierOutputList() {
        return tenderInviteSupplierOutputList;
    }

    public void setTenderInviteSupplierOutputList(List<DailyBiddingSupplierOutput> tenderInviteSupplierOutputList) {
        this.tenderInviteSupplierOutputList = tenderInviteSupplierOutputList;
    }

    public List<DailyBiddingSupplierOutput> getTenderFirstSupplierOutputList() {
        return tenderFirstSupplierOutputList;
    }

    public void setTenderFirstSupplierOutputList(List<DailyBiddingSupplierOutput> tenderFirstSupplierOutputList) {
        this.tenderFirstSupplierOutputList = tenderFirstSupplierOutputList;
    }

    public List<DailyBiddingSupplierOutput> getTenderSignSupplierOutputList() {
        return tenderSignSupplierOutputList;
    }

    public void setTenderSignSupplierOutputList(List<DailyBiddingSupplierOutput> tenderSignSupplierOutputList) {
