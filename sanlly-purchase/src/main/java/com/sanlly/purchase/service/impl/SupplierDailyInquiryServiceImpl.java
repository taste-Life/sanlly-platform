...
/**
 * @Description: TODO
 * @ClassName: SupplierDailyInquiryServiceImpl
 * @Version 1.0
 * @Author mqz
 */
@Service
public class SupplierDailyInquiryServiceImpl extends  BaseServiceImpl implements SupplierDailyInquiryService {
    // 询价采购
    @Autowired
